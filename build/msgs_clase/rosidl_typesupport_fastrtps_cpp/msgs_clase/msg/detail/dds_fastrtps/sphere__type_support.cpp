...
#include "msgs_clase/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_msgs_clase
cdr_serialize(
  const msgs_clase::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  msgs_clase::msg::Sphere & ros_message)
{
  // Member: center
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msgs_clase::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msgs_clase::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msgs_clase::msg::Sphere *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_msgs_clase
const rosidl_message_type_support_t *
get_message_type_support_handle<msgs_clase::msg::Sphere>()
{
  return &msgs_clase::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msgs_clase, msg, Sphere)() {
  return &msgs_clase::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
